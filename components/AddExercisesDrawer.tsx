...
const AddExercisesDrawer = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-x-hidden">
      ...
      <aside
        className={clsx(
          "absolute right-0 top-0 flex h-full w-full min-w-0 flex-col overflow-x-hidden border-l border-white/15 bg-black px-4 pt-5 shadow-2xl md:px-5",
      ...
      >
        ...
        >
            ...
            <div className="hidden min-h-0 flex-col border-r border-white/10 pr-4 md:flex">
              ...
              <div className="mt-auto flex gap-3 border-t border-white/10 pt-4 pb-4">
                <button
                  type="button"
                  onClick={handleClose}
                  className="btn-outline h-11 min-h-0 flex-1 px-2 py-0 text-[14px] md:min-h-0 md:px-2 md:py-0 md:text-[14px]"
                >
                  Cancel
                </button>
                <button
                  type="button"
                  disabled={!canSave}
                  className="btn-primary h-11 min-h-0 flex-1 px-2 py-0 text-[14px] md:min-h-0 md:px-2 md:py-0 md:text-[14px]"
                  onClick={handleSave}
                >
          ...
          <div className="flex min-h-0 min-w-0 flex-col">
            ...
            <div className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden pr-2 meals-scrollbar">
              <div className="mb-4">
